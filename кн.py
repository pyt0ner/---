...
phonk = PhotoImage(width = 1, height = 1)
new_game = Button(root, image = phonk, text = "новая игра", background = "#FFFF00", foreground = "#000000", width = 360, height = 90, compound = "c", font = "Arial 24", command = restart_program)
new_game.place(x = 0, y = 0)


button1 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button1.place(x = 0, y = 90)
button2 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button2.place(x = 120, y = 90)
button3 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button3.place(x = 240, y = 90)
button4 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button4.place(x = 0, y = 210)
button5 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button5.place(x = 120, y = 210)
button6 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button6.place(x = 240, y = 210)
button7 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button7.place(x = 0, y = 330)
button8 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
button8.place(x = 120, y = 330)
button9 = Button(root, image = phonk, width = 120, height = 120, compound = "c", bg = "#FFA500", activebackground = "#FFA500")
